...
def main_menu():
    ...
    try:                
        ...
        if choice not in range(1,4):
            logging.error("The choice is out of range, it must be for 1 to 3")
    except ValueError :
...
def addition_menu():
    choice_script = '''
                    Hi, welcome to your income tracking interface.
                    What typ of addition you want to do:
                    [1] Add Bank Account
                    [2] Add Transaction
    ...
    try:                
        ...
        if choice not in range(1,6):
            logging.error("The choice is out of range, it must be for 1 to 5")
    except ValueError :
        logging.error("Invalid value! Give an integer")
...
def suppression_menu():
    choice_script = '''
                    Hi, welcome to your income tracking interface.
                    What typ of suppression you want to do:
